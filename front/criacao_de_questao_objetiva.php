...
<style>
    * { box-sizing: border-box; }
    ...
    .coluna_imagem, .coluna_alternativas { flex: 1; display: flex; flex-direction: column; }
...
<div class="pagina">
    ...
    <main>
        <div class="titulo_pagina">+ Adicionar questão objetiva</div>
