...
<style>
    * { box-sizing: border-box; }
    ...
    .coluna_imagem, .coluna_enunciado { flex: 1; display: flex; flex-direction: column; }
    ...
    .area_imagem img { max-width: 100%; max-height: 100%; display: none; border-radius: 4px; }
    .icone_upload { font-size: 36px; margin-bottom: 8px; }
    .coluna_enunciado textarea { flex: 1; width: 100%; padding: 12px; border: 2px solid #ccc; border-radius: 6px; font-size: 15px; font-family: Arial, Helvetica, sans-serif; outline: none; resize: none; background: rgb(240,245,250); min-height: 240px; }
    .coluna_enunciado textarea:focus { border-color: #3182ce; }
...
<div class="pagina">
    ...
    <main>
        <div class="titulo_pagina">+ Adicionar questão dissertativa</div>
    ...
    function previewImagem(event) {
        ...
        if (file) {
            ...
            reader.onload = e => {
                ...
                document.getElementById('placeholder_upload').style.display = 'none';
            };
